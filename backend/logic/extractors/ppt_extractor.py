...
from ..extractors.ocr_utils import extract_table_or_text, clean_text_df
...
def extract_and_segregate_media(pptx_path, output_base_dir):
    ...
    """
    file_types = {
        "images": [".png", ".jpg", ".jpeg", ".gif", ".bmp", ".tiff", ".jfif", ".webp"],
...
def extract_presentation_content(ppt_path, img_texts):
    ...
    for idx, slide in enumerate(prs.slides, start=1):
        ...
        # OCR injection for slide images
